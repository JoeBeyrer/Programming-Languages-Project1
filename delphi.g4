...
typeDefinition
    : identifier EQUAL (type_ | functionType | procedureType | interfaceType)
    ;
...
classType
    : CLASS (LPAREN identifierList RPAREN)? classBlock END
    ;
...
interfaceType
    : INTERFACE (LPAREN identifier RPAREN)? interfaceBlock END
    ;
